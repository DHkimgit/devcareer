    ...
    if (!isset($_GET['id']) || empty($_GET['id'])) {
        ...
        if (!$problem_id) {
            ...
            try {
                ...
                $stmt_delete_problem = $pdo->prepare("DELETE FROM programmers_problem WHERE id = :id AND user_id = :user_id");
                ...
                $pdo->rollBack();
                error_log("Programmers Problem Delete DB Error: " . $e->getMessage());
